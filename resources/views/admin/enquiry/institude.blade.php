...
<u1 class="uk-child-width-2-3@l" data-uk-grid style="width:70%;margin-left:auto;margin-right:auto">
    ...
    <li>
                ...
                <div class="uk-grid-divider uk-grid-collapse" data-uk-grid>
                    <div class="uk-width-1-3@l uk-flex uk-flex-middle uk-flex-center uk-position-relative md-bg-light-green-50">
                        ...
                        <div class="sc-padding-medium uk-text-center">
                            @if($institutions->img)
                            <img src="{{url('files/'.$institutions->img)}}" style="width:100px;height:100px" class="sc-avatar sc-border" alt="xerdman" />
                            @else
                            ...
                            <p class="uk-margin-remove sc-color-secondary uk-text-medium">{{$institutions->registration_number}}</p>
                        </div>
                    </div>
                            ...
                            <ul class="uk-list uk-list-divider">
                                <li class="sc-list-group">
                                    ...
                                    <div class="sc-list-body">
                                        <p class="uk-margin-remove sc-text-semibold">{{$institutions->phone}}</p>
                                    </div>
                                </li>
                                <li class="sc-list-group">
                                    <div class="sc-list-addon"><i class="mdi mdi-email"></i></div>
                                    <div class="sc-list-body">
                                        <p class="uk-margin-remove">{{$institutions->email}}</p>
                                    </div>
                                </li>
                                <li class="sc-list-group">
                                ...
                                <li class="sc-list-group">
                                    ...
                                    <div class="sc-list-body">
                                        <p class="uk-margin-remove uk-text-wrap">
                                            ...
                                            @foreach($institutions->offer_course as $service)
                                            {{$service}},
                                            @endforeach
                                            @endif
                                        </p>
        ...
        <div data-uk-dropdown="pos: bottom-center">
            <ul class="uk-nav uk-dropdown-nav">
                <li><a href="{{route('institution.admin.view',['id' => $institutions->id])}}" style="color:#17a2b8;">1) View Registration/Enrollment </a></li>
                <li><a href="#" style="color:#17a2b8;">2) View Status progress reports</a></li>
            </ul>
        </div>
    </li>
            ...
            <a href="#">
                ...
                <div data-uk-dropdown="pos: bottom-center">
                    <ul class="uk-nav uk-dropdown-nav">
                        ...
                        <li><a href="{{route('admin.candidateEnquiry',['id' => $row->candidate_personalsId])}}" style="color:#17a2b8;">5) View Enquiries </a></li>
