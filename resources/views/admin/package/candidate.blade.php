...
<div id="modal-close-Price" data-uk-modal>
    <div class="uk-modal-dialog uk-modal-body" style="width:700px">
        ...
        <form action="{{route('candidate.price.post')}}" method="post">
            @csrf
...
<h6 style="text-align:center;color:#3f6791">Candidate Package Price</h6>
...
<script>
    $(document).ready(function() {
        ...
        $('.page-Packages-Candidate ').addClass('sc-page-active')
    });
</script>
@endsection