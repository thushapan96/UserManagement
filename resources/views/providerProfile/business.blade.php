            ...
            <div class="col-md-3 border-left" style="  left: 80px;">
                <div class="d-flex flex-column align-items-left text-left p-3 py-5">
                    ...
                    <div class="col-md-7 float-left">
                        <a href="{{route('dashboard.business')}}"> <button type="button" class="client-btn ">GO to dashboard</button></a>
                    </div>
                    @else
                    <div class="col-md-7 float-left">
                ...
                <div class="">
                    <div class="cardf">
                        <nav class="nav nav-pills nav-fill justify-content-left " style="cursor:pointer; text-decoration: underline !important">
                            <a class="nav-link active amenu" style="cursor:pointer;padding: .5rem 1.5rem;color:#004e75 !important" aria-current="page" id="amenu">Main Content</a>
                            <a class="nav-link amenu1" style="cursor:pointer;padding: .5rem 1.5rem;color:#004e75 !important" id="amenu1">Team </a>
                            <a class="nav-link amenu2" style="cursor:pointer;padding: .5rem 1.5rem;color:#004e75 !important" id="amenu2">About Company </a>
                            <a class="nav-link amenu3" style="cursor:pointer;padding: .5rem 1.5rem;color:#004e75 !important" id="amenu3"> Award & Certification</a>
                            <a class="nav-link amenu4" style="cursor:pointer;padding: .5rem 1.5rem;color:#004e75 !important" id="amenu4">News and Events</a>
                ...
                <div class="row tab-pane  " id="menu">
                    <div class="card col-5">
                        ...
                        <div class="row custom-box">
                            ...
                            <div class="col-md-7">
                                <label class="labels"> {{$consultants->first_name}} {{$consultants->last_name}} {{$consultants->registration_number}}</label><br>
                            </div>
                        </div><br>
                    ...
                    <div class="card col-5">
                        ...
                        <div class="row custom-box">
                            <div class="col-md-5">
                                <strong class="labels">Initial chargeable type</strong>
                            </div>
