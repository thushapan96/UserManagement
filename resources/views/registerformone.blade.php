            ...
            <div class="row custom-box">
                ...
                <div class="row m-1 sameaddress" id="sameaddress">
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="form-group">
                            <label></label>
                            <input class="form-control l-icon" type="text" placeholder="Choose Country" name="Choose Country" id="pac-input1" value="" required>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-4 ">
                        <div class="custom-control custom-radio ">
                            ...
                            <label class="custom-control-label mt-1" for="customradio3">Prefer Not to say </label>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <a class="facebook" href="##">
                                ...
                                <div id="facebook" class="col-lg-11 col-md-11 col-11 d-none ">
                                    <div class="form-group">
                                        <label> </label>
                                        <input class="form-control " type="text" placeholder="Facebook Profile ">
                                    </div>
                                </div>
                            </a>
