                    ...
                    <div class="col-lg-12 col-md-12 col-12 container addschool mt-4">
                        <div class="whiteBox clearfix">
                            ...
                            <div class="float-right">
                                <button class=" closebtn client-btn btn btn-danger" id="removeschool" style="background:#bf0010 !important"><a style="color:white"><i class="fa fa-solid fa-minus"></i> Remove</a></button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="addcollegeform">
                    <div class="container addcollege mt-4">
                        <div class="whiteBox clearfix">
                            ...
                            <div class="float-right">
                                <button type="submit" class=" closebtn client-btn btn btn-danger" id="removecollege" style="background:#bf0010 !important"><a style="color:white"><i class="fa fa-solid fa-minus"></i> Remove</a></button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="addpgform">
                    <div class="whiteBox clearfix">
                        ...
                        <div class="row custom-box">
                            ...
                            <div class="float-right">
                                <button type="submit" class=" closebtn client-btn btn btn-danger" id="removepg" style="background:#bf0010 !important">
                                    <a style="color:white">
                ...
                <div id="addotherform">
                    <div class="container addother mt-4">
                        <div class="whiteBox clearfix">
                            ...
                            <div class="float-right">
                                <button type="submit" class=" closebtn client-btn btn btn-danger" id="removeother" style="background:#bf0010 !important"><a style="color:white"><i class="fa fa-solid fa-minus"></i> Remove</a></button>
                            </div>
        ...
        $(document).ready(function() {
            ...
            $("#addschoolbtn").click(function() {
                ...
                html = `<div  id="addschoolform"> 
                    ...
                    <div class="float-right">
                    <button  class=" closebtn  btn btn-danger" id="removeschool" style="background:#bf0010 !important"><a style="color:white"><i class="fa fa-solid fa-minus"></i> Remove</a></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        `
            ...
            $("#collegebtn").click(function() {
                ...
                <div class="whiteBox clearfix">
                    ...
                    <div class="float-right">
                    <button type="submit" class=" closebtn client-btn btn btn-danger" id="removecollege" style="background:#bf0010 !important"><a 
            ...
            $("#pgbtn").click(function() {
                ...
                html = `<div  id="addpgform">  <div class="container addpg mt-4">
                    ...
                    <div class="float-right">
                    <button type="submit" class=" closebtn client-btn btn btn-danger" id="removepg" style="background:#bf0010 !important"><a  style="color:white">
           ...
           <div  id="addotherform">
            <div class="container addother mt-4">
                <div class="whiteBox clearfix">
                    ...
                    <div class="float-right">
                    <button type="submit" class=" closebtn client-btn btn btn-danger" id="removeother" style="background:#bf0010 !important"><a 
                            style="color:white"><i class="fa fa-solid fa-minus"></i> Remove</a></button>
                            </div>
